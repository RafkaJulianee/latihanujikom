    ...
    <div class="col-lg-9">
        <div class="admin-card p-4 p-md-5">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h5 class="fw-bold text-dark-navy mb-1 text-uppercase" style="letter-spacing: 0.5px;">Form Ubah Artikel</h5>
                    <small class="text-muted">Perbarui isi konten artikel atau blog</small>
                </div>
            ...
            <form action="{{ route('admin.artikel.update', $artikel->id_artikel) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <div class="mt-2 d-flex align-items-center gap-3 p-2 bg-light rounded-3 border">
                        <img src="{{ $artikel->gambar_url }}" alt="Preview" width="56" height="56" class="rounded-3 border" style="object-fit: cover;">
                        <small class="text-muted">Gambar sampul saat ini. Unggah file baru jika ingin mengganti.</small>
                    </div>
                    @error('gambar')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="d-flex gap-2 pt-2 border-top">
                    <button type="submit" class="btn btn-primary-blue px-4">
                        <i class="fa-solid fa-save me-1"></i> Perbarui Artikel
                    </button>
