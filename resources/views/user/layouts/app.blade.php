...
<head>
    ...
    <title>@yield('title', 'PT Solusi Koneksi')</title>
    ...
    <header class="header-navbar-wrapper">
        <div class="container">
            <nav class="navbar navbar-expand-lg py-0">
                <!-- Brand Logo Link -->
                <a class="brand-logo-link text-decoration-none d-flex align-items-center" href="{{ route('home') }}#home">
                    <img src="{{ $profil->logo_url ?? asset('img/ptsolusikoneksi.jpg') }}" alt="{{ $profil->nama_perusahaan ?? 'PT Solusi Koneksi' }}" width="38" height="38" class="rounded-3 me-2 object-fit-cover shadow-sm">
                    <span class="fw-black text-dark-navy letter-spacing-1 fs-4" style="font-family: 'Outfit', sans-serif; font-weight: 900;">PT Solusi Koneksi</span>
                </a>
    ...
    <footer class="pt-5 pb-4 mt-5">
        <div class="container">
            <div class="row g-4 mb-5">
                ...
                <div class="col-lg-4">
                    <a class="brand-logo-link text-white mb-3 d-inline-flex align-items-center gap-2 text-decoration-none" href="{{ route('home') }}#home">
                        <img src="{{ $profil->logo_url ?? asset('img/ptsolusikoneksi.jpg') }}" alt="{{ $profil->nama_perusahaan ?? 'PT Solusi Koneksi' }}" width="38" height="38" class="rounded-3 object-fit-cover shadow-sm">
                        <span class="fw-black text-white letter-spacing-1 fs-4" style="font-family: 'Outfit', sans-serif; font-weight: 900;">PT Solusi Koneksi</span>
                    </a>
                    <p class="text-white-50 small pe-lg-4">
                        {{ $profil->tentang ?? 'Mitra pengembangan website, aplikasi mobile, dan solusi sistem digital terintegrasi untuk bisnis Anda.' }}
                    </p>
                ...
                <div class="col-6 col-lg-2 ms-auto">
                    ...
                    <ul class="list-unstyled text-white-50 small d-flex flex-column gap-2">
                        ...
                        <li><a href="{{ route('home') }}#artikel">Artikel &amp; Insight</a></li>
                    </ul>
                </div>
                ...
                <div class="col-lg-3">
                    ...
                    <p class="text-white-50 small mb-1"><i class="fa-solid fa-envelope me-2 text-primary-blue"></i> {{ $profil->email ?? 'contact@solusikoneksi.com' }}</p>
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-center small text-white-50 pt-2">
                <p class="mb-0">&copy; {{ date('Y') }} PT Solusi Koneksi. Hak Cipta Dilindungi.</p>
