...
@section('title', 'Profil Perusahaan - ZICODE')
...
<section class="bg-dark-navy text-white py-5">
    <div class="container py-3 text-center">
        ...
        <h1 class="display-5 fw-bold mb-3">Tentang Perusahaan ZICODE</h1>
        <p class="text-white-50 max-w-600 mx-auto fs-6">
            Mengenal lebih dekat profil, visi, misi, dan komitmen profesional di balik layanan ZICODE.
        </p>
    </div>
</section>
    ...
    <div class="container py-3">
        <div class="row g-5 align-items-center mb-5">
            <div class="col-lg-6">
                ...
                <h2 class="display-6 fw-bold text-dark-navy mb-4">{{ $profil->nama_perusahaan ?? 'ZICODE DIGITAL AGENCY' }}</h2>
                <div class="fs-6 text-muted leading-relaxed mb-4">
                    {{ $profil->tentang ?? 'ZICODE adalah penyedia layanan teknologi dan transformasi digital yang berfokus pada pengembangan produk berkualitas tinggi, desain intuitif, serta performa maksimal bagi perkembangan bisnis Anda.' }}
                </div>
            </div>
            <div class="col-lg-6">
                <div class="position-relative">
                    <img src="{{ asset('img/team.jpg') }}" class="img-fluid rounded-4 shadow-sm border" alt="Tim ZICODE">
                </div>
            </div>
        </div>
